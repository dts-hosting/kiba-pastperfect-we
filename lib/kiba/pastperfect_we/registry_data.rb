    ...
    module RegistryData
      ...
      def register_files
        ...
        Ppwe.registry.namespace("catalog_item") do
          ...
          register :relation, {
            path: File.join(dir, "catalog_item_relation.csv"),
            creator: Ppwe::Jobs::CatalogItem::Relation,
            tags: %i[review catalog_item relation],
            dest_special_opts: {
              initial_headers: Ppwe::CatalogItem.base_fields
            }
          }
        ...
        Ppwe.registry.namespace("review") do
          ...
          register :site, {
            ...
            dest_special_opts: {
              initial_headers: [:id, Ppwe::Splitting.item_type_field,
                Ppwe.review_target_field, :sitenumberandname,
                :duplicatesitenumberandname]
            }
          }
          register :url, {
          ...
          register :user, {
            ...
            tags: %i[review user],
            dest_special_opts: {
              initial_headers: [:userid, Ppwe::Splitting.item_type_field,
                Ppwe.review_target_field, :fullname,
                :duplicatefullname]
            }
          }
        end
