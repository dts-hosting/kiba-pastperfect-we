      ...
      def base_config
        ...
        setting :lookup_ids,
          default: {
            ...
            "CatalogItemInscription" => :catalogitemid,
            "CatalogItemInsurance" => :catalogitemid,
            ...
            "LoanActivities" => :loanid,
            "LoanAttachment" => :loanid,
            "LoanCatalogItems" => :loanid,
            "LoanShippingInformation" => :loanid,
            "LoanUrl" => :loanid,
